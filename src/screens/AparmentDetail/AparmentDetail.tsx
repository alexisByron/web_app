...
import { aparmentDetailProps } from "./interface/IAparmentDetail";
      ...
      <div style={{ width: "95%", maxWidth: "1000px", margin: "auto" }}>
        ...
        >
          <div
            ...
            style={{
              cursor: "pointer",
              backgroundImage: 'url("' + aparmentSelected.imgs[0] + '")',
        ...
        >
          <div className="left-col" style={{ marginBottom: "100px", width: "60%" }}>
            ...
            >
              {aparmentSelected.title}
            </p>

            <p style={{ color: "#8CA5C6", fontWeight: 500, fontSize: "14px" }}>
              Publicado {aparmentSelected.createdAt}
            </p>
            ...
            >
              <p style={{ fontSize: "14px" }}>
                <InlineIcon icon={vectorIcon} /> {aparmentSelected.dimentions}
              </p>
              <p style={{ fontSize: "14px" }}>
                <InlineIcon icon={bedIcon} /> {aparmentSelected.bedRooms}{" "}
                Habitaciones
              </p>
              <p style={{ fontSize: "14px" }}>
                <InlineIcon icon={toiletIcon} /> {aparmentSelected.bathRoom}{" "}
                Baños
              </p>
              <p style={{ fontSize: "14px" }}>
                <InlineIcon icon={carIcon} />{" "}
                {aparmentSelected.parking > 0
                  ? `${aparmentSelected.parking} Estacionamiento`
                  : "Sin estacionamiento"}{" "}
              </p>
            </div>
          ...
          <div>
            ...
            >
              <div
                className="row-price d-flex justify-content-between"
              ...
              <div
                className="row-price ligh-grey d-flex justify-content-between mb-3 align-items-center mt-2"
                style={{ fontWeight: 500, fontSize: "14px", color: "#616161" }}
              >
                <div className="left-item">Gastos comunes aprox</div>
                <div className="rigth-item" style={{ fontSize: "18px" }}>
                  $50.000
                </div>
              </div>
