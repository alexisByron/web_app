       ...
       <Header />
        ...
        <div style={{display:'flex',gridColumnGap: '10px',justifyContent:'center',width:'90%',}}>
          <div style={{margin:'auto'}}>
             <h1 className="text-center" style={{width:'60%',margin:'auto',marginRight:'0px',fontFamily: 'Inter',fontStyle: 'normal',fontWeight: 800,fontSize: '48px',lineHeight: '48px'}}>
            Contrata SIN aval y 
            realiza todo 100% online
           </h1>
          </div>
          <div style={{marginBottom:'0px'}}>
            <img src={monoHome} alt="persona" />
          </div>
        </div>
      <Steeps />
      <ContactForm />
